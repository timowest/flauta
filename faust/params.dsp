...
max_jet_vel = 40;
step_Uj = 0.1;
flue_labium_distance = hslider("flue-labium dist", 4e-3, 0.0005, 0.0127, 0.0001); // 0.0005 - 0.0127
max_flue_labium_d = 0.016;
labium_position = hslider("labium position", 0.0002, 0, 0.00127, 0.0001);
convection_f = 0.5;
...
jet_height = hslider("jet height", 1e-3, 5e-05, 0.00127, 0.0001); // 5e-05 - 0.00127
jet_width = 0.02;
delta_d = 1.0e-3;
